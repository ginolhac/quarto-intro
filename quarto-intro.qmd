...
- Learn about the different possibilities:
    ...
    + Presentations
        + This one, [rendered: {{< fa brands github >}} pages](), : rendered: [https://ginolhac.github.io/quarto-intro/](https://ginolhac.github.io/quarto-intro/)
    + Websites and blogs
    + Dashboards
    + Books
    + Manuscripts
...
- But you must use `git` {{< fa brands git >}}, as you do anyway right?
- Two examples:
...
:::: {.columns}
::: {.column width="50%"}
- More verbose, {{< fa brands docker >}} explicit
