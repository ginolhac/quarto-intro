...
- Learn about the different possibilities:
    ...
    + Presentations
        + This one, rendered: {{< fa brands gitlab >}} [https://uniluxembourg.gitlab.io/fstm/dlsm/bioinfo/quarto-intro/](https://uniluxembourg.gitlab.io/fstm/dlsm/bioinfo/quarto-intro/)
    + Websites and blogs
    + Dashboards
    + Books
    + Manuscripts
- Render to the output format you want
- The bioinformatics team (Anthoula and I)
    + What we do
...
Extended Rmarkdown. Languages and Integrated Development Editor agnostic
...
- Text file that can (should) be tracked by a version control system (like {{< fa brands git >}} [git](https://git-scm.com/))
    + {{< fa brands gitlab >}} [UNI gitlab](https://gitlab.com/uniluxembourg/fstm)
...
Creating project at /home/ginolhac/Jottacloud/DLSM/Seminars/2024-quarto-intro/dlsm-bioinfo:
  - Created _quarto.yml
  - Created .gitignore
  - Created index.qmd
